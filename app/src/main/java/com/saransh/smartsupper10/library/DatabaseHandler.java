...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addNotices(String food_name,String pic_link,String type,String food_desc) {
    	SQLiteDatabase db = this.getWritableDatabase();
    	
    	ContentValues values = new ContentValues();
        values.put(KEY_SUBJECT, food_name);
        values.put(KEY_MESSAGE, type);
        values.put(KEY_POSTED_BY, pic_link);
        values.put(KEY_DATE, food_desc);
